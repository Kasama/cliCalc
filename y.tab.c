...
{
  "$end", "error", "$undefined", "VARIABLE", "INTEGER", "PLUS", "MINUS",
  "MULT", "DIV", "ASSIGN", "LPARENT", "RPARENT", "LINEFEED", "$accept",
  "program", "line", "expression", "mults", "term", "number", "var", YY_NULLPTR
};
#endif
...
{
       6,    -3,    -3,    24,    24,    24,    -3,     3,     6,     1,
      25,    -3,    -3,    12,    -3,    -3,    -3,     9,     8,    -3,
      -3,    24,    24,    -3,    24,    24,    24,    -3,    -3,    25,
      25,    -3,    -3,    30
};
...
{
       0,    20,    18,     0,     0,     0,     6,     0,     3,     0,
      10,    13,    17,    19,    14,    19,    15,     0,    19,     1,
       2,     0,     0,     4,     0,     0,     0,     5,    16,     8,
       9,    11,    12,     7
};
...
{
      13,    14,    16,    19,    17,    18,    21,    22,    13,     1,
       2,     3,     4,    23,    21,    22,     5,    26,     6,    20,
      28,    26,    31,    32,    27,    33,    18,     1,     2,     3,
       4,     0,    24,    25,     5,    21,    22,    29,    30
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     0,     5,     5,     5,     6,     8,     3,
       4,     5,     6,    12,     5,     6,    10,     9,    12,     8,
      11,     9,    24,    25,    12,    26,    26,     3,     4,     5,
       6,    -1,     7,     8,    10,     5,     6,    21,    22
};
...
{
       0,     3,     4,     5,     6,    10,    12,    14,    15,    16,
      17,    18,    19,    20,    18,    20,    18,    16,    20,     0,
      14,     5,     6,    12,     7,     8,     9,    12,    11,    17,
      17,    18,    18,    16
};
...
#line 52 "calc.y" /* yacc.c:1646  */
    { printf("%c = %d\n", (yyvsp[-1].v), ACCESS((yyvsp[-1].v))); }
#line 1263 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 57 "calc.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); ACCESS((yyvsp[-2].v)) = (yyvsp[0].num); }
